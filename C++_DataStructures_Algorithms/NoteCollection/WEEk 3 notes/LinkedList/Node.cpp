...
template<class ItemType>
Node<ItemType>::Node(const ItemType& anItem, Node<ItemType>* nextNodePtr,Node<ItemType>* prevPtr) :
                item(anItem), next(nextNodePtr), prev(prevPtr)
{
} // end constructor
...
template<class ItemType>
void Node<ItemType>::setPrev(Node<ItemType>* prevPtr) {
    prev = prevPtr;
}
