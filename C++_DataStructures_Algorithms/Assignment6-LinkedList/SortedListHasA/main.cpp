...
int main()
{
	...
	*/
//--------------------------------------------------------------------
	// Student portion of the main, create a high score that lets user input 
	// Note: copy and pasted "displayList"above but made it work for ints.
	int score;
	char again = 'y';
	SortedListInterface<int>* list = new SortedListHasA<int>();
	
	cout << "Right now the LeaderBoard is empty lets change that!\n";
	do {

		do {
			cout << " \nPlease enter your score! Also don't lie! Also also negatives don't count, crazy right? ";
			cin >> score;
			if (score < 0)
				cout << "Plese enter a valid score.\n";
		} while (score < 0);
	...
	cout << "Thanks for participating! Here is the final leaderboard: \n";
	cout << endl;
	displayList(list);
   return 0;
}  // end main
...
/*
  Jose Gonzalez 3/15/2021 Assignment 6:HighScores
 STUDENT OUTPUT:

 Right now the LeaderBoard is empty lets change that!

Please enter your score! Also don't lie! Also also negatives don't count, crazy right? 4
...
Please enter your score! Also don't lie! Also also negatives don't count, crazy right? 1
...
Please enter your score! Also don't lie! Also also negatives don't count, crazy right? 25
...
Please enter your score! Also don't lie! Also also negatives don't count, crazy right? -3
Plese enter a valid score.

Please enter your score! Also don't lie! Also also negatives don't count, crazy right? -6
Plese enter a valid score.

Please enter your score! Also don't lie! Also also negatives don't count, crazy right? 15
...
Add another? (y/n)n
Thanks for participating! Here is the final leaderboard:
