...
int main()
{
   ...
   */
    ...
    // This the the actual student/ work main function for this assignment
    ...
    cout << "We will begin by testing our new add function that should add nodes randomly.";
    cout << "\nWe will create three trees, each with the same inputs and the output should be different:" << endl;
    tree1->inorderTraverse(display);
    cout << endl;
